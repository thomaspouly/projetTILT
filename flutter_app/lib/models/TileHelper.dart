    ...
    List<Tile> list = <Tile>[
     ...
     Tile(
      ...
      Tile(
          ...
          counter: 0,
          increment: 0.25,
          description: "D'après une étude de l'OMS, 4,9 millions de décès auraient été attribuables à l'exposition à des produits chimiques dans l'environnement en 2004, cela équivaut à un décès toutes les 4 secondes (compteur). Il existe environ 248.000 produits chimiques disponibles dans le commerce dont un grand nombre pouvant avoir des effets néfastes sur la santé humaine, la faune et l'environnement."),
      Tile(
          id: 11,
